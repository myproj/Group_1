...
openiputtest(void)
{
  ...
  sleep(1);
     ...
     2a8:	6a 01                	push   $0x1
     2aa:	e8 d0 3c 00 00       	call   3f7f <sleep>
...
sbrktest(void)
{
  ...
  oldbrk = sbrk(0);
    ...
    3115:	6a 00                	push   $0x0
    3117:	e8 5b 0e 00 00       	call   3f77 <sbrk>
  ...
  a = sbrk(0);
    ...
    3125:	6a 00                	push   $0x0
    3127:	e8 4b 0e 00 00       	call   3f77 <sbrk>
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    313e:	6a 01                	push   $0x1
    3140:	e8 32 0e 00 00       	call   3f77 <sbrk>
...
#define BIG (100*1024*1024)
  a = sbrk(0);
    ...
    3215:	6a 00                	push   $0x0
    3217:	e8 5b 0d 00 00       	call   3f77 <sbrk>
  ...
  p = sbrk(amt);
    ...
    3237:	50                   	push   %eax
    3238:	e8 3a 0d 00 00       	call   3f77 <sbrk>
  ...
  *lastaddr = 99;
  ...
  c = sbrk(0);
    ...
    32ba:	6a 00                	push   $0x0
    32bc:	e8 b6 0c 00 00       	call   3f77 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3320:	6a 00                	push   $0x0
    3322:	e8 50 0c 00 00       	call   3f77 <sbrk>
  ...
  a = sbrk(0);
    ...
    337e:	6a 00                	push   $0x0
    3380:	e8 f2 0b 00 00       	call   3f77 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34ae:	6a 00                	push   $0x0
    34b0:	e8 c2 0a 00 00       	call   3f77 <sbrk>
    ...
    34c4:	50                   	push   %eax
    34c5:	e8 ad 0a 00 00       	call   3f77 <sbrk>
    ...
    34eb:	e8 8f 0a 00 00       	call   3f7f <sleep>
  ...
  c = sbrk(4096);
    ...
    352e:	e8 44 0a 00 00       	call   3f77 <sbrk>
  ...
  if(sbrk(0) > oldbrk)
    ...
    3599:	6a 00                	push   $0x0
    359b:	e8 d7 09 00 00       	call   3f77 <sbrk>
...
validatetest(void)
{
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    365b:	6a 00                	push   $0x0
    365d:	e8 1d 09 00 00       	call   3f7f <sleep>
    3662:	83 c4 10             	add    $0x10,%esp
    sleep(0);
    3665:	83 ec 0c             	sub    $0xc,%esp
    3668:	6a 00                	push   $0x0
    366a:	e8 10 09 00 00       	call   3f7f <sleep>
...
00003f57 <getppid>:
SYSCALL(getppid)
    3f57:	b8 18 00 00 00       	mov    $0x18,%eax
    3f5c:	cd 40                	int    $0x40
    3f5e:	c3                   	ret    

00003f5f <getsyscallinfo>:
SYSCALL(getsyscallinfo)
    3f5f:	b8 19 00 00 00       	mov    $0x19,%eax
    3f64:	cd 40                	int    $0x40
    3f66:	c3                   	ret    

00003f67 <getAllPids>:
SYSCALL(getAllPids)
    3f67:	b8 16 00 00 00       	mov    $0x16,%eax
    3f6c:	cd 40                	int    $0x40
    3f6e:	c3                   	ret    

00003f6f <shutdown>:
SYSCALL(shutdown)
    3f6f:	b8 17 00 00 00       	mov    $0x17,%eax
    3f74:	cd 40                	int    $0x40
    3f76:	c3                   	ret    

00003f77 <sbrk>:
SYSCALL(sbrk)
    3f77:	b8 0c 00 00 00       	mov    $0xc,%eax
    3f7c:	cd 40                	int    $0x40
    3f7e:	c3                   	ret    

00003f7f <sleep>:
SYSCALL(sleep)
    3f7f:	b8 0d 00 00 00       	mov    $0xd,%eax
    3f84:	cd 40                	int    $0x40
    3f86:	c3                   	ret    

00003f87 <uptime>:
SYSCALL(uptime)
    3f87:	b8 0e 00 00 00       	mov    $0xe,%eax
    3f8c:	cd 40                	int    $0x40
    3f8e:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    42f8:	50                   	push   %eax
    42f9:	e8 79 fc ff ff       	call   3f77 <sbrk>
