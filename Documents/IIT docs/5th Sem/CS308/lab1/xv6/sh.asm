...
00000f5d <getppid>:
SYSCALL(getppid)
     f5d:	b8 18 00 00 00       	mov    $0x18,%eax
     f62:	cd 40                	int    $0x40
     f64:	c3                   	ret    

00000f65 <getsyscallinfo>:
SYSCALL(getsyscallinfo)
     f65:	b8 19 00 00 00       	mov    $0x19,%eax
     f6a:	cd 40                	int    $0x40
     f6c:	c3                   	ret    
...
00000f7d <sbrk>:
SYSCALL(sbrk)
     f7d:	b8 0c 00 00 00       	mov    $0xc,%eax
     f82:	cd 40                	int    $0x40
     f84:	c3                   	ret    

00000f85 <sleep>:
SYSCALL(sleep)
     f85:	b8 0d 00 00 00       	mov    $0xd,%eax
     f8a:	cd 40                	int    $0x40
     f8c:	c3                   	ret    

00000f8d <uptime>:
SYSCALL(uptime)
     f8d:	b8 0e 00 00 00       	mov    $0xe,%eax
     f92:	cd 40                	int    $0x40
     f94:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12fe:	50                   	push   %eax
    12ff:	e8 79 fc ff ff       	call   f7d <sbrk>
